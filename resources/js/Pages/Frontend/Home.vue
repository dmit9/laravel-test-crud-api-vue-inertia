                        ...
                        <div class="mb-3 flex  border  rounded p-2 bg-gray-100">
                            <div class="">
                                <div class="col-lg-6 col-6 border border-secondary ml-1 rounded  p-1">
                                    ...
                                    <li><a href="/public/api/v1/users">/api/v1/users</a></li>
                                    <li><a href="/public/api/v1/positions">/api/v1/positions</a></li>
                                    <li><a href="/public/api/v1/users/5">/api/v1/users/5</a></li>
                                </div>
                            </div>
                        </div>
